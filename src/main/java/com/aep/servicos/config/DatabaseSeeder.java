...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public DatabaseSeeder(ServicoRepository servicoRepository, SolicitacaoRepository solicitacaoRepository, UsuarioRepository usuarioRepository, PasswordEncoder passwordEncoder) {
        ...
        if (servicoRepository.count() == 0) {
            ...
            List<Solicitacao> solicitacoes = Arrays.asList(
                Solicitacao.builder()
                    ...
                    .descricao("Gostaria de pintar a sala de estar e um quarto de casal. Já tenho a tinta branca, preciso que o profissional traga as ferramentas.")
                ...
                Solicitacao.builder()
                    ...
                    .descricao("O ar condicionado do quarto não está gelando bem e está fazendo barulho. Preciso de uma limpeza e revisão geral.")
